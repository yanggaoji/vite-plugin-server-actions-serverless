# Vite Server Actions - React TODO App Example

This is an example of a simple TODO application that uses [Vite Server Actions](https://github.com/HelgeSverre/vite-plugin-server-actions) and [React](https://reactjs.org/) to demonstrate a real-world use case, where server actions are used to save, list, and delete TODOs, with data stored in a JSON file.
...
Open [http://localhost:5173](http://localhost:5173) to view it in your browser. (Note: The port may vary, check the console output for the correct port)
...
- `src/App.jsx` - The main React component that imports and calls the server actions to manage TODOs.
