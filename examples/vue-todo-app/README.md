# Vite Server Actions - Vue TODO App Example

This is an example of a simple TODO application that uses [Vite Server Actions](https://github.com/HelgeSverre/vite-plugin-server-actions) and [Vue 3](https://vuejs.org/) to demonstrate a real-world use case, where server actions are used to save, list, and delete TODOs, with data stored in a JSON file.
